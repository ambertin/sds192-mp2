...
jobs <- c("REGISTERED NURSE", "TEACHER", "SOCIAL WORKER", "FARMER", "CONSTRUCTION", "WAITER", "REAL ESTATE", "ACCOUNTANT", "SOFTWARE ENGINEER", "MARKETING", "POLICE OFFICER", "CONTRACTOR", "CEO", "LAWYER", "EXECUTIVE", "ENGINEER", "DOCTOR", "ANESTHESIOLOGIST", "POLICE OFFICER")
