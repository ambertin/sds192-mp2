...
• 1) While individuals in higher income jobs are expected across the board to donate a higher total amount to campaigns (e.g. ALL doctors combined will donate more than ALL social workers combined), but how does the median individual donation compare across occupations?  Do their donations still appear as significant after accounting for income level? 
...
ggplot(partisanship_gathered, aes(x = occupation, y = num_committees, fill = party)) +
  ...
  scale_fill_discrete(name= "Committee Affiliation", breaks = c("D","R"), labels = c("Democratic", "Republican"))
